...
const Footer = () => {
  ...
  return (
    <footer className="relative py-12 bg-gradient-to-t from-black to-[#140d24] border-t border-purple-900/20">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <a href="#" className="text-2xl font-bold inline-block mb-4">
              <span className="text-purple-400">Sudip</span>
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-purple-600/20 transition-colors"
                aria-label="Github"
                target="_blank"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#expertise" className="text-gray-400 hover:text-purple-400 transition-colors">Expertise</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">
                ...
                <a href="mailto:sudiprajkunwar@gmail.com" className="hover:text-purple-400 transition-colors">
        ...
        <div className="border-t border-purple-900/20 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between">
