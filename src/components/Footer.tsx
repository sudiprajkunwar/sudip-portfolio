        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="w-10 h-10 rounded-full glass-morphism flex items-center justify-center hover:bg-purple-500/20 transition-colors"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">
                ...
                <a href="mailto:your.email@example.com" className="hover:text-purple-400 transition-colors">your.email@example.com</a>
              </li>
              <li className="text-gray-400">
