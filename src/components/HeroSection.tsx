  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-4 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-3/5 text-center md:text-left">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-4 text-white">
              Hello, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-indigo-400">Sudip Raj Kunwar</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8 justify-center md:justify-start">
              <a
                href="#about"
                className="px-8 py-3 rounded-full bg-gradient-to-r from-cyan-500 to-indigo-500 text-white font-medium hover:shadow-lg hover:shadow-cyan-500/20 transition-all transform hover:-translate-y-1"
              >
                About Me
              </a>
              <a
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              <a href="#" className="p-2 rounded-full bg-white/5 border border-white/10 hover:bg-cyan-500/20 transition-all">
        ...
        <div className="md:w-2/5 mt-8 md:mt-0">
          <div className={`relative transition-all duration-1000 delay-300 ease-out ${
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-cyan-500/20 to-indigo-500/20 rounded-full blur-xl"></div>
            <div className="relative p-2 bg-gradient-to-tr from-cyan-500 to-indigo-500 rounded-full">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <a href="#about" className="text-white/80 hover:text-cyan-400 transition-colors">
          <ChevronDown size={24} />
        </a>
      </div>
    </section>
