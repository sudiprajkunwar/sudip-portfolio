    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-10">
          ...
          <div 
            className={`w-24 h-1 bg-gradient-to-r from-gray-700 to-black mx-auto mb-4 transition-all duration-1000 delay-200 ease-out ${
              isVisible ? "opacity-100 scale-100" : "opacity-0 scale-0"
            }`}
          ></div>
          <p className={`text-gray-600 max-w-2xl mx-auto transition-all duration-1000 delay-300 ease-out ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
          >
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {area.skills.map(skill => (
                      <Badge 
                        key={skill} 
                        variant="outline" 
                        className="bg-gray-100 border-gray-300 text-gray-800 hover:bg-gray-200 text-xs"
                      >
                        {skill}
                      </Badge>
                    ))}
